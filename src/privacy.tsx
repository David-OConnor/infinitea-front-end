...
export default () => (
    <div>
        ...
        <p>We use your data to provide and improve the Service. By using the Service,
            ...
            Privacy Policy have the same meanings as in our Terms and Conditions, linked at the bottom of this page.</p>
        ...
        <p>Infinitea uses the collected data for various purposes:</p>
        <ul>
        ...
        <p>If you are from the European Economic Area (EEA), the legal basis for collecting
        ...
        <p>Infinitea may process your Personal Data because:</p>
        <ul>
        ...
        <p>Infinitea will take all steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of your data and other personal information.</p>

        <h3>Disclosure Of Data</h3>

        <h3>Legal Requirements</h3>
        <p>Infinitea may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
        <ul>
            <li>To comply with a legal obligation</li>
            <li>To protect and defend the rights or property of Infinitea</li>
